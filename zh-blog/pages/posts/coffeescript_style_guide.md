---
layout: post
title: CoffeeScript 编码风格指南（译）
date: 2014-06-21 23:47:32
categories:
- Web
- CoffeeScript
tags:
...
- [灵感](#灵感)
- [目录](#目录)
- [代码布局（Code Layout）](#代码布局code-layout)
  - [Tab 还是 空格？（Tabs or Spaces?）](#tab-还是-空格tabs-or-spaces)
  - [最大行宽（Maximum Line Length）](#最大行宽maximum-line-length)
  - [空行（Blank Lines）](#空行blank-lines)
  - [结尾空白（Trailing Whitespace）](#结尾空白trailing-whitespace)
  - [可选的逗号（Optional Commas）](#可选的逗号optional-commas)
  - [编码（Encoding）](#编码encoding)
- [模块导入（Module Imports）](#模块导入module-imports)
- [表达式和语句中的空白（Whitespace in Expressions and Statements）](#表达式和语句中的空白whitespace-in-expressions-and-statements)
- [注释（Comments）](#注释comments)
  - [块注释（Block Comments）](#块注释block-comments)
  - [行内注释（Inline Comments）](#行内注释inline-comments)
- [命名规范（Naming Conventions）](#命名规范naming-conventions)
- [函数（Functions）](#函数functions)
- [字符串（Strings）](#字符串strings)
- [条件判断（Conditionals）](#条件判断conditionals)
- [循环和列表解析（Looping and Comprehensions）](#循环和列表解析looping-and-comprehensions)
- [扩展本地对象（Extending Native Objects）](#扩展本地对象extending-native-objects)
- [异常（Exceptions）](#异常exceptions)
- [注解（Annotations）](#注解annotations)
- [其他（Miscellaneous）](#其他miscellaneous)

<a href="#code_layout"/>
## 代码布局（Code Layout）

<a href="#tabs_or_spaces"/>
### Tab 还是 空格？（Tabs or Spaces?）

只用 **空格**，每级缩进均为 **2 个空格**。切勿混用 Tab 和空格。

<a href="#maximum_line_length"/>
...
<a href="#trailing_whitespace"/>
### 结尾空白（Trailing Whitespace）

不要在任何一行保留行尾空白。

<a href="#optional_commas"/>
...
<a href="#looping_and_comprehensions"/>
...
<a href="#extending_native_objects"/>
...
- [原文地址](https://github.com/polarmobile/coffeescript-style-guide/blob/master/README.md)
- [中文版地址](http://geekplux.github.io/coffeescript-style-guide)
- [原 Github 地址](https://github.com/polarmobile/coffeescript-style-guide)
- [中文版 Github 地址](https://github.com/geekplux/coffeescript-style-guide)
